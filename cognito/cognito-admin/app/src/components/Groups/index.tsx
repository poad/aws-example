import { Backdrop, Box, Container, createStyles, Dialog, DialogContent, DialogContentText, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TableSortLabel, Theme } from "@material-ui/core";
                            ...
                            <TableBody>
                                {
                                    stableSort(groups.map(group => ({
                                        ...
                                        .map((item) =>
                                            <TableRow key={item.groupName} onClick={() => { openGroupDetail(item.origin) }}>
