...
const AddTodoModal = ({ modalVisible, setModalVisible }: { modalVisible: boolean, setModalVisible: React.Dispatch<React.SetStateAction<boolean>> }): JSX.Element => {
...
const TodoList = () => {
    ...
    async function setComplete(updateValue: boolean, todo: Todo) {
        //to be filled in a later step
        await DataStore.save(
