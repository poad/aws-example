import { Backdrop, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TablePagination, TableSortLabel, Container, Box, Dialog, DialogContent, DialogContentText } from '@material-ui/core';
                        ...
                        <TableBody>
                            {
                                stableSort(users.map(user => ({
                                    ...
                                    .map((item) =>
                                        <TableRow key={item.email} onClick={() => { openUserDetail(item.origin) }}>
